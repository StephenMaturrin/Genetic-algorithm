...
plt.plot(y[0], y[1], 'rs',y[0], y[1], 'r',y[0], y[2], 'g^',y[0], y[2], 'g',y[0], y[3], 'b',y[0], y[3], 'bX',)
plt.ylabel('Fitness/Distance')
plt.xlabel('Iterations')


# Meilleure Fitness;Moyenne Fitness
red_patch = mpatches.Patch(color='red', label='Meilleure Fitnes')
green_patch = mpatches.Patch(color='green', label='Moyenne Fitness')
